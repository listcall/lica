Rails.application.routes.draw do
  ...
  ztst_pgs = %w(index icons react1 react2 react3 chat pack1 pack2)
  ...
  # resources :services , controller: 'svcs'
  # resources :svc_hours
  # resources :svc_periods
  ...
  namespace :admin do
    ...
    # resources :forum_index
    # resources :forum_partners
    # resources :drive_index
    # resources :drive_partners
    # resources :wiki_index
    # resources :wiki_partners
    ...
    # resources :svc_sorts
    # resources :svc_index
    # resources :svc_partners
    # resources :svc_reps
    # resources :svc_reps_pickers
    resources :quals
