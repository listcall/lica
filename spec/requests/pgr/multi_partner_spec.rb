...
describe 'Multi-Partner Pager Interaction', :focus do
  ...
  #   before(:each) { hydrate(mem1, mem3, partnership); request_login(mem1) }
  #   it 'handles a single message' do
  #     post '/paging', req.paging_mail_opts(mem1, mem3)
  #     expect(Pgr::Assignment.count).to       eq(2)
  ...
  #     post '/paging', req.paging_mail_opts(mem1, mem3)
  #     post '/letter_opener_reply', req.mail_reply_opts(mem3, team1)
  #     expect(Pgr::Assignment.count).to       eq(2)
  #     expect(Pgr::Broadcast.count).to        eq(1)
  #     expect(Pgr::Dialog.count).to           eq(1)
  ...
  #     post '/paging', req.paging_mail_opts(mem1, mem3)
  #     post '/letter_opener_reply', req.mail_reply_opts(mem3, team1)
  #     post "/paging/#{req.broadcast_id}/for/#{req.dialog_id}", req.web_reply_opts(mem1)
  #     expect(Pgr::Broadcast.count).to        eq(1)
  #     expect(Pgr::Dialog.count).to           eq(1)
